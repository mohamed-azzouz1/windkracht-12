        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Gebruiker Bewerken</h2>
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.accounts.show', $user->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded">
                ...
                <form method="POST" action="{{ route('admin.accounts.update', $user->id) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-1">Nieuw Wachtwoord <span class="text-xs text-gray-500">(leeg laten om ongewijzigd te houden)</span></label>
