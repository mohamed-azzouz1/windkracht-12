        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-800">Nieuwe Les Inplannen</h1>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="student_id" id="student_id" required
                                    ...
                                    @foreach($students as $student)
                                        <option value="{{ $student->id }}" {{ old('student_id', $default_student_id) == $student->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="instructor_id" id="instructor_id" required
                                    ...
                                    @foreach($instructors as $instructor)
                                        <option value="{{ $instructor->id }}" {{ old('instructor_id', $default_instructor_id) == $instructor->id ? 'selected' : '' }}>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="date" id="date" required
                                           value="{{ old('date', $default_date ?? now()->format('Y-m-d')) }}" 
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    @error('date')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
